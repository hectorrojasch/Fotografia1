...
class PhotographiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photography" do
    assert_difference("Photography.count") do
      post photographies_url, params: { photography: { description: @photography.description, name: @photography.name, tag_id: @photography.tag_id, user_id: @photography.user_id } }
    end
  ...
  test "should update photography" do
    patch photography_url(@photography), params: { photography: { description: @photography.description, name: @photography.name, tag_id: @photography.tag_id, user_id: @photography.user_id } }
